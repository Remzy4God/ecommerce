			   ...
			   <!-- Collect the nav links, forms, and other content for toggling -->
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav nav_1">
						<!--<li><a href="products.html">Royce Rolls</a></li>-->
						<li><a href="royce1.php">Royce Rolls</a></li>
		...
		<div class="w3l_banner_nav_right">
			...
			<h4>Best products</h4>
             <?php 
              ...
              $query=mysqli_query($connect,"SELECT * FROM products WHERE car_category='home'");
              while ($row=mysqli_fetch_array($query)) {
              
             ?> 
			<form method="post" action="products1.php?action=add&id=<?php echo $row['serial_no'];?>">
			<div class="col-sm-3" style="border:1px solid gold;">
				
              <center><img src="<?php echo $row['product_image']; ?>" width='150' height='170'>
	          ...
	          <!-- <a class="btn btn-success" href="view_cart.php?product_id=<?php echo $row['serial_no'].'&action=add '; ?>">Add to Cart</a> -->
              </center>
					...
					<table class="table table-bordered">
						...
						<?php 
      						...
      						<tr>
      							...
      							<td><a href="products1.php?action=delete&id=<?php echo $values['item_id']; ?>"><span class="text-danger">Remove</span></a></td>
      						</tr>		
      						<?php
