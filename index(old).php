...
<body>
<!-- header -->
	<div><h1 style="background: gold; text-align: center;">Online Excel Car Deals</h1></div>
...
<!-- banner -->
	<div class="banner">
		...
		<div class="w3l_banner_nav_right"><!--CHECK HERE FOR SLIDER IMAGES-->
			<section class="slider">
				<div class="flexslider">
					<ul class="slides">
						<li>
							<div class="w3l_banner_nav_right_banner">
								<h3>Highlander <span>2018</span> Model</h3>
								<div class="more">
						...
						<li>
							<div class="w3l_banner_nav_right_banner1">
								<h3>Kia Sorento<span>2018</span> Model.</h3>
								<div class="more">
									<a href="products.html" class="button--saqui button--round-l button--text-thick" data-text="Shop now">Shop now</a>
								</div>
							</div>
