								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.html"><img src="<?php echo $row['product_image']; ?>" alt=" " class="img-responsive" style="height: 70px;"/></a>
											<center><p style="font-size: 1.02em;">Honda Civic</p>
											<h4>#4.8 Million</h4></center>
										</div>
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
													...
													<input type="hidden" name="item_name" value="Honda Civic" />
