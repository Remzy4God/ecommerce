			   ...
			   <!-- Collect the nav links, forms, and other content for toggling -->
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav nav_1">
						<li><a href="products1.php">Royce Rolls</a></li>
						<li><a href="products1.php">Royce Rolls</a></li>
			...
			include ('database/database.php');
             if (isset($_GET['product_id']))
				...
				if (isset($_SESSION['cart'])){
					...
					echo "<th>Price</th>";
					echo "<th align='center'>Quantity</td>";
					echo "<th align='center'>Add</td>";
					echo "<th align='center'>Subtotal</td>";
					echo "</tr>";
					...
					foreach ($_SESSION['cart'] as $product_id => $x) {
						  $result=mysqli_query($connect,"Select * from products where serial_no=$product_id");
		                   ...
		                   //$brand=$myrow['product_brand'];
		                 	...
		                 	echo "<tr>";
		                 	echo "<td><img src='".$row['product_image']."' height='100'/></td>";
                            ...
                            echo "<td align='center'>#$line_cost";
